...
const Blogs = () => {
    return (
        <div className='container my-5'>
            ...
            <p>Javascript is a programming language that is used to write website scripts.NodeJS is a runtime environment for Javascript.Javascript can only be executed in browsers.NodeJs is mostly used on the server-side.In frontend development, Javascript is used. Nodejs is used in server-side development. 	Javascript is capable enough to add HTML and play with the DOM. Nodejs does not have capability to add HTML tags. It is basically used on the client-side. It is mostly used on the server-side.</p>
