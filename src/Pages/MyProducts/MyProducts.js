...
const MyProducts = () => {
  ...
  useEffect(() => {
    const getMyProducts = async () => {
      ...
      const url = `https://rocky-crag-37831.herokuapp.com/inventory/myItems?email=${email}`;
      try {
